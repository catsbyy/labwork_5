...
// − конструктор, в якому задаються розміри матриці; check!
// − метод для заповнення матриці випадковими числами; check!
//− перевантаження операції «*» для множення матриці (приймає у вигляді параметра на вхід матрицю В)
//і повертає результат перемноження поточної матриці на матрицю В у вигляді нового об'єкта класу "Матриця";
// − метод, що знаходить і повертає визначник матриці; check!
// − метод, що знаходить і повертає транспоновану матрицю; check!
// − метод, що знаходить і повертає обернену матрицю. check!
